...
#endif
//各种类型的对象，在他们自己的模块都有一个叫free_list 的缓存数组，呵呵，就这样吧
...
author :Mike
*/
int PyDict_Dump(PyDictObject* pobj,FILE *f,int flags){
	return dict_print(pobj,f,flags);
}
