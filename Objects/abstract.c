...
/*
func可以是metaclass,一般是PyType_Type ，也可以是用户自定义的类型对象，这个类型对象的ob_type 也常常是 PyType_Type
PyType_Type的 ob_type是 PyType_Type自己，PyType_Type->tp_call==type_call
*/
PyObject *
PyObject_Call(PyObject *func, PyObject *arg, PyObject *kw)
{//arg 就是PyObject_CallFunctionObjArgs中打包得到tuple对象
...
/*
创建class object, 字节码 BUILD_CLASS 会到这里，PyObject_CallFunctionObjArgs( metaclass, name, bases, methods, NULL)
一般metaclass 是 PyType_Type
*/
PyObject *
PyObject_CallFunctionObjArgs(PyObject *callable, ...)
{
    ...
    //准备参数,返回的 args 是一个PyTuple_Object
	args = objargs_mktuple(vargs);
    va_end(vargs);
    if (args == NULL)
        return NULL;
