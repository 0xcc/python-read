...
static void show_character(PyStringObject *a);
static Py_ssize_t
...
PyString_InternInPlace(PyObject **p)
{
    ...
    Py_REFCNT(s) -= 2;
	//s->ob->sstate=SSTATE_INTERNED_MORTAL;
